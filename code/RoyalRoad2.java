...
public class RoyalRoad2 implements IFitnessFunction {

    private static String name = "RoyalRoad2 Problem";
    ...
    private Schema[] schemata = new Schema[] {
            ...
            new Schema("************************************************11111111********", 8),
            new Schema("********************************************************11111111", 8),
            new Schema("1111111111111111************************************************", 16),
            new Schema("****************1111111111111111********************************", 16),
            new Schema("********************************1111111111111111****************", 16),
            new Schema("************************************************1111111111111111", 16),
            new Schema("11111111111111111111111111111111********************************", 32),
            new Schema("********************************11111111111111111111111111111111", 32),
    };
